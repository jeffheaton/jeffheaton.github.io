...
function randomize() {
	...
	document.getElementById("w0").value = w[0];
	document.getElementById("w1").value = w[1];
	document.getElementById("w2").value = w[2];
	document.getElementById("w3").value = w[3];
	document.getElementById("w4").value = w[4];
	document.getElementById("w5").value = w[5];
	document.getElementById("w6").value = w[6];
	document.getElementById("w7").value = w[7];
	document.getElementById("w8").value = w[8];
...
function trainOnline(input,expected,prev_delta) {
	var w = [];
	w.push(parseFloat(document.getElementById("w0").value));
	...
	var mom = parseFloat(document.getElementById("m").value);
	...
	// Display calculation
	document.getElementById("calculationDisplay").innerHTML = table_html+output;
}
...
function trainBatch(prev_delta) {
	...
	// Display calculation
	document.getElementById("calculationDisplay").innerHTML = output;
}
